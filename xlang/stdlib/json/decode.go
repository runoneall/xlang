...
func Decode(data []byte) (xlang.Object, error) {
	var d decodeState
...
func (d *decodeState) array() (xlang.Object, error) {
	var arr []xlang.Object
	for {
	...
	return &xlang.Array{Value: arr}, nil
}

func (d *decodeState) object() (xlang.Object, error) {
	m := make(map[string]xlang.Object)
	for {
	...
	return &xlang.Map{Value: m}, nil
}

func (d *decodeState) literal() (xlang.Object, error) {
	...
	default: // number
		...
		if isFloat {
			...
			return &xlang.Float{Value: n}, nil
		}
		n, _ := strconv.ParseInt(string(item), 10, 64)
		return &xlang.Int{Value: n}, nil
	}
}
